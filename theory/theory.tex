...
Acc. physics should clearly be introduced. Emittance, brightness, twiss parameter need to be defined. Floettmann\cite{PhysRevSTAB.6.034202}. A good book should be used here. Don't know which one,yet. TBD.

Use Jamies book \cite{Book_Fundamentals_Rosenzweig}
